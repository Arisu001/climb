...
tellraw @a [{"text": "═════════════[ ", "color": "#19df5", "bold": true}, {"text": "Climb", "color": "light_purple"}, {"text": " ]═════════════"}]
tellraw @a ""
...
execute as @a unless predicate src:this/inventory/climb run function src:cmd/tlw/mess/i_help
